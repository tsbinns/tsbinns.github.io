...
<div>
  ...
  <p class="CV-desc">
    ...
    <br>
    <button onclick="location.href='https://mne.tools/mne-connectivity/stable/auto_examples/mic_mim.html'" type="button">Go to tutorial</button>
  </p>
  ...
  <p class="CV-desc">
    ...
    <br>
    <button onclick="location.href='https://mne.tools/mne-connectivity/stable/auto_examples/granger_causality.html'" type="button">Go to tutorial</button>
  </p>
</div>