...
<div>
  ...
  <h3 class="CV-header">08/2019 - 08/2020</h3>
    ...
    <ul class="CV-desc_with_logo" style="margin-top: 0;">
      <li>Associated with my work as a <a href="#Haynes-Lab">Researcher in the Haynes Laboratory of the Bernstein Center for Computational Neuroscience, Germany</a>.</li>
    </ul>
...
<div>
  <h3 class="CV-header">Neuroscience Student Prize &nbsp;<a href="/assets/documents/Neuroscience_Student_Prize.pdf"><i class="fas fa-file-pdf"></i></a></h3>
    <ul class="CV-desc">
