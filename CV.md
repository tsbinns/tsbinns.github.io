...
<div>
  <h3>
    2019 - 2020<br>
    <i>Investigating choice-predictive brain signals using EEG-based brain-computer interfaces.</i> &euro;5,000.
  </h3>
  <p style="margin-left: 20px;">Erasmus+ Traineeship grant, British Council.</p>
  <h3>
    2018<br>
    <i>Free Will and Neural Activity in Consequential Action.</i> &pound;2,000.
  </h3>
  <p style="margin-left: 20px;">Biomedical Vacation Scholarship, Wellcome Trust.</p>
</div>
