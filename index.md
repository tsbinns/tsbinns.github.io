...
<script>
  const myTimeout = setTimeout(fixWidgetWidth, 5000)

  function fixWidgetWidth()
    document.getElementById("twitter-widget-0").width = "100%";
</script>
