...
<svg aria-label="Email" class="icon"><use xlink:href="{{ "/assets/fontawesome/icons.svg" | relative_url }}#{{ envelope }}"></use></svg> Email: [t.s.binns@outlook.com](mailto:t.s.binns@outlook.com)
